...
while alive:
    ...
    if action== "s":
        ...
        if arrows==0:
            ...
            if shoot=="s" and playerLocationY==wompusY+1 and playerLocationX==wompusX: 
                print( Fore.BLUE,Back.YELLOW,"you killed the wompus nice job as you hear its dying breath you fell good",Style.RESET_ALL)
